...
import { fetchShareCard } from '../../sendService.js';
...
CPage({
  ...
  onLoad: function (options) {
    ...
    //this._queryParam.smartTripId = 4042768;
  ...
  loadData: function () {
    fetchShareCard(this._queryParam.smartTripId, this._queryParam.uid).then(res => {
      ...
      this.setData({
        ...
        fromUid: this._queryParam.uid,
        smartTripId: this._queryParam.smartTripId
      })

...
export const loadNeededCardData = function(originCardDetail) {
  ...
  let result = {
    ...
    ticketCode: originCardDetail.trainCard.electronicOrderNo,
    passengerList: originCardDetail.trainCard.passengerList,
    orderDetailUrl: originCardDetail.trainCard.orderDetailUrl,
    orderStatusName: originCardDetail.trainCard.orderStatusName,
    ...
    isShowHeader: originCardDetail.cardSource == 1/*订单*/
  };
  ...
  if (originCardDetail.trainCard.departureLocation &&
    ...
    result.location = {
      ...
      actionCode: 'c_train_detail_map_navigate_click'
    };
  }

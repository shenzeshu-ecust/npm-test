...
Component({
  ...
  methods: {
    ...
    getNode: function (t) {
      for (
        var e = t.split('_'), i = this.data.childs[e[0]], r = 1;
        r < e.length;
        r++
      )
        i = i.children[e[r]];
    ...
    play: function (t) {
      if (this.root.data.pauseVideo) {
        for (var e = !1, i = t.target.id, r = this.root._videos.length; r--; )
          this.root._videos[r].id === i
            ? (e = !0)
            : this.root._videos[r].pause();
        if (!e) {
    ...
    linkTap: function (t) {
      ...
      this.root.triggerEvent(
        'linktap',
        Object.assign({ innerText: this.root.getText(e.children || []) }, i)
      ),
        r &&
          ('#' === r[0]
            ...
            : cwx.navigateTo({
                url: r,
                fail: function () {
                  cwx.switchTab({ url: r, fail: function () {} });
                },
              }));
    },
    mediaError: function (e) {
      ...
      if ('video' === r.name || 'audio' === r.name) {
        ...
        if ((s > r.src.length && (s = 0), s < r.src.length))
          return this.setData(t({}, 'ctrl.' + i, s));
      } else
        'img' === r.name &&
          this.data.opts[2] &&

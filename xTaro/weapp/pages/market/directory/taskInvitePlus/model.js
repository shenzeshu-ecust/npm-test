...
const model = {
    ...
    queryInviteExtend: (params) => fetchWrap('22598', 'queryInviteExtend', params),
    ...
    inviteHelpAward: (params) => fetchWrap('22598', 'inviteHelpAward', params),
    awardTask: (params) => fetchWrap('22598', 'awardTask', params),
}
